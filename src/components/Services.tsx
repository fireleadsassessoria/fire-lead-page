  ...
  const services = [
    {
      ...
      description:
        "Anúncios otimizados no Google e Instagram que trazem clientes famintos pelo seu delivery. ROI garantido.",
      benefits: [
        "Campanhas testadas",
        "Segmentação precisa",
        "Resultados rápidos",
    ...
    },
    {
      ...
      description:
        "Assessoria no seu cardápio digital. Aumente o seu faturamento sem depender de marketplaces com taxas abusivas.",
      benefits: [
        "Zero taxas de marketplace",
        "100% do lucro é seu",
        "Marca própria independente",
      ],
    },
    {
      icon: HeartHandshake,
      ...
      description:
        "Acompanhamento próximo e estratégias para fidelizar seus clientes e aumentar o ticket médio.",
      benefits: [
        "Suporte dedicado",
        "Análise de métricas",
    ...
    },
    {
      ...
      description:
        "Criamos e gerenciamos conteúdo que engaja, educa e converte seguidores em clientes.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Tudo que você precisa em um único lugar. Sem complicação, só
            resultados.
          </p>
        </div>
